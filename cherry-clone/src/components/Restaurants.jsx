// if i am using local images then images folder ko public folder main copy karna padega and img link should be acc to the reference of index.html

// IMP -> while using map always remember 2 things --> 1) always provide a key to the component which is called inside map and, 2) use ()
    ...
    <div className="container divider">
      <div className="cards">
        {props.restaurants.map((rest) => (
          <Restaurant key={rest.id} rest={rest} />
        ))}
        {/* <div className="card">
